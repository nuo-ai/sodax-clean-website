...
const statKeys = ['homesCleaned', 'customerSatisfaction', 'averageRating', 'yearsExperience'] as const;
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <p className="mt-4 text-base-gray md:w-1/2 text-left">{t('heading.description')}</p>
          </div>
        </div>
